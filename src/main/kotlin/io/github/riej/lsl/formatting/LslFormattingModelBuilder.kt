...
class LslFormattingModelBuilder : FormattingModelBuilder {
    ...
    fun createSpacingBuilder(settings: CodeStyleSettings): SpacingBuilder {
        ...
        return SpacingBuilder(settings, LslLanguage.INSTANCE)
            ...
            .betweenInside(LslTypes.PARENTHESES_LEFT, LslTypes.PARENTHESES_RIGHT, LslTypes.EXPRESSION_FUNCTION_CALL).spaceIf(commonSettings.SPACE_WITHIN_EMPTY_METHOD_CALL_PARENTHESES)
            ...
            .afterInside(LslTypes.PARENTHESES_LEFT, LslTypes.EXPRESSION_PRINT).spaceIf(commonSettings.SPACE_WITHIN_METHOD_CALL_PARENTHESES)
            .beforeInside(LslTypes.PARENTHESES_RIGHT, LslTypes.EXPRESSION_PRINT).spaceIf(commonSettings.SPACE_WITHIN_METHOD_CALL_PARENTHESES)
            ...
            .aroundInside(LslTypes.TYPE_NAME, LslTypes.EXPRESSION_TYPE_CAST).spaceIf(commonSettings.SPACE_WITHIN_CAST_PARENTHESES)
            ...
            .betweenInside(LslTypes.PARENTHESES, LslTypes.EXPRESSIONS, LslTypes.EXPRESSION_TYPE_CAST).spaceIf(commonSettings.SPACE_AFTER_TYPE_CAST)
            .betweenInside(identifierSet, LslTypes.PARENTHESES, LslTypes.EXPRESSION_FUNCTION_CALL).spaceIf(commonSettings.SPACE_BEFORE_METHOD_CALL_PARENTHESES)
            .betweenInside(identifierSet, LslTypes.PARENTHESES, LslTypes.FUNCTION).spaceIf(commonSettings.SPACE_BEFORE_METHOD_PARENTHESES)
            .betweenInside(identifierSet, LslTypes.PARENTHESES, LslTypes.EVENT).spaceIf(commonSettings.SPACE_BEFORE_METHOD_PARENTHESES)
            .betweenInside(LslTypes.IF, LslTypes.PARENTHESES_LEFT, LslTypes.STATEMENT_IF).spaceIf(commonSettings.SPACE_BEFORE_IF_PARENTHESES)
            .betweenInside(LslTypes.WHILE, LslTypes.PARENTHESES_LEFT, LslTypes.STATEMENT_WHILE).spaceIf(commonSettings.SPACE_BEFORE_WHILE_PARENTHESES)
            .betweenInside(LslTypes.WHILE, LslTypes.PARENTHESES_LEFT, LslTypes.STATEMENT_DO).spaceIf(commonSettings.SPACE_BEFORE_WHILE_PARENTHESES)
            .betweenInside(LslTypes.FOR, LslTypes.PARENTHESES_LEFT, LslTypes.STATEMENT_FOR).spaceIf(commonSettings.SPACE_BEFORE_FOR_PARENTHESES)
            ...
            .betweenInside(LslTypes.IDENTIFIER, LslTypes.BRACE_LEFT, LslTypes.DEFAULT_STATE_DECLARATION).spaceIf(commonSettings.SPACE_BEFORE_CLASS_LBRACE)
            ...
            .beforeInside(LslTypes.STATEMENT_ELSE, LslTypes.STATEMENT_IF).spaceIf(commonSettings.SPACE_BEFORE_ELSE_KEYWORD)
