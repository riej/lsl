...
public class LslIfStatementImpl extends ASTWrapperPsiElement implements LslIfStatement {

  public LslIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public LslElseStatement getElseStatement() {
    return findChildByClass(LslElseStatement.class);
  }
